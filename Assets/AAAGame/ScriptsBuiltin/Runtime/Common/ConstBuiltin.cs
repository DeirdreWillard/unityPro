...
public static class ConstBuiltin
{
    ...
    internal const string DES_KEY = "Xp7@kT2q";//网络数据DES加密
    public readonly static string RES_KEY = "M9t$R6pL";//AB包加密解密key
    ...
    public static class Setting
    {
        ...
        /// 最后一次公告弹出时间
        /// </summary>
        public readonly static string LastOpenNoticeTime = "Setting.LastOpenNoticeTime";
    }
}
