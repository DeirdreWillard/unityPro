...
public class CameraFollower : MonoBehaviour
{
    ...
    {
        // Built-in 渲染管道下，UI 相机通过 depth 层级来控制渲染顺序
        // 确保 UI 相机的 depth 大于主相机
        if (GFBuiltin.UICamera != null && GFBuiltin.UICamera.depth <= mainCam.depth)
        {
            GFBuiltin.UICamera.depth = mainCam.depth + 1;
        }
    }
