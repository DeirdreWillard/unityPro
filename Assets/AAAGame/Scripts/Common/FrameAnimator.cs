...
public class FrameAnimator : MonoBehaviour
{
    ...
    /// 是否忽略Image的Scale
    /// </summary>
    [SerializeField]private bool ignoreImageScale = false;
    ...
    /// </summary>
    public event Action<GameObject> FinishEvent;
    //目标Image组件
    private Image image;
    //目标SpriteRenderer组件
    ...
    //从曲线值计算当前帧率
            ...
            currentFramerate = curvedFramerate;
    //帧率有效
    ...
    //执行更新操作
                ...
                GF.LogWarning ("Framerate got '0' value, animation stopped.");
            }
#endif
        }
    }
    ...
    //索引越界，表示已经到结束帧
        if (nextIndex < 0 || nextIndex >= frames.Length) {//广播事件
            if (FinishEvent != null) {
                FinishEvent(gameObject);
            }
    //非循环模式，禁用脚本
            if (loop == false) {
